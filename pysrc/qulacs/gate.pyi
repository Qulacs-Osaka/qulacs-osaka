...
def ParametricPauliRotation_existing_parameter(index_list: List[int], pauli_ids: List[int], parameter_id: int, parameter_coef: float = ...) -> QuantumGate_SingleParameter: ...
def ParametricRX(index: int, angle: float = ...) -> QuantumGate_SingleParameter: ...
def ParametricRX_existing_parameter(index: int, parameter_id: int, parameter_coef: float = ...) -> QuantumGate_SingleParameter: ...
def ParametricRY(index: int, angle: float = ...) -> QuantumGate_SingleParameter: ...
def ParametricRY_existing_parameter(index: int, parameter_id: int, parameter_coef: float = ...) -> QuantumGate_SingleParameter: ...
def ParametricRZ(index: int, angle: float = ...) -> QuantumGate_SingleParameter: ...
def ParametricRZ_existing_parameter(index: int, parameter_id: int, parameter_coef: float = ...) -> QuantumGate_SingleParameter: ...
