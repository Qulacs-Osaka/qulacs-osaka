...
PYBIND11_MODULE(qulacs, m) {
    ...
    py::class_<QuantumState, QuantumStateBase>(m, "QuantumState")
        ...
        .def("sampling",
            (std::vector<ITYPE>(QuantumState::*)(UINT, UINT)) &
                QuantumState::sampling,
            "Sampling measurement results", py::arg("count"), py::arg("seed"))
    ...
    py::class_<DensityMatrix, QuantumStateBase>(m, "DensityMatrix")
        ...
        .def("load",
            (void (DensityMatrix::*)(const ComplexMatrix&)) &
                DensityMatrix::load,
            "Load density matrix", py::arg("state"))
    ...
    py::class_<QuantumStateGpu, QuantumStateBase>(m, "QuantumStateGpu")
        .def(py::init<unsigned int>(), "Constructor", py::arg("qubit_count"))
        .def(py::init<unsigned int, unsigned int>(), "Constructor",
            py::arg("qubit_count"), py::arg("gpu_id"))
    ...
    py::class_<QuantumGateMatrix, QuantumGateBase>(m, "QuantumGateMatrix")
        ...
        .def(
            ...
            "Get gate matrix")
        .def("__repr__",
            [](const QuantumGateMatrix& p) { return p.to_string(); });
    ;
    ...
    mgate.def(
        ...
        pybind11::return_value_policy::take_ownership,
        "Create dense matrix gate", py::arg("index_list"), py::arg("matrix"));
    mgate.def(
        "SparseMatrix",
        [](std::vector<unsigned int> target_qubit_index_list,
    ...
    QuantumGateMatrix* (*ptr3)(const QuantumGateBase*, const QuantumGateBase*) =
        &gate::merge;
    mgate.def("merge", ptr3, pybind11::return_value_policy::take_ownership,
        "Merge two quantum gate", py::arg("gate1"), py::arg("gate2"));

    QuantumGateMatrix* (*ptr4)(std::vector<const QuantumGateBase*>) =
        &gate::merge;
    mgate.def("merge", ptr4, pybind11::return_value_policy::take_ownership,
        "Merge quantum gate list", py::arg("gate_list"));

    QuantumGateMatrix* (*ptr5)(const QuantumGateBase*, const QuantumGateBase*) =
        &gate::add;
    mgate.def("add", ptr5, pybind11::return_value_policy::take_ownership,
        "Add quantum gate matrices", py::arg("gate1"), py::arg("gate2"));

    QuantumGateMatrix* (*ptr6)(std::vector<const QuantumGateBase*>) =
        &gate::add;
    ...
    mgate.def("Adaptive",
        py::overload_cast<QuantumGateBase*,
            std::function<bool(const std::vector<unsigned int>&, unsigned int)>,
    ...
    py::class_<QuantumCircuit>(m, "QuantumCircuit")
        ...
        .def("add_random_unitary_gate",
            &QuantumCircuit::add_random_unitary_gate, "Add random unitary gate",
            py::arg("index_list"))
    ...
    py::class_<GradCalculator>(m, "GradCalculator")
        .def(py::init<>())
        .def("calculate_grad", &GradCalculator::calculate_grad,
            "Calculate Grad");
    ...
    py::class_<NoiseSimulatorMPI>(m, "NoiseSimulatorMPI")
        .def(py::init<QuantumCircuit*, QuantumState*>(), "Constructor")
        .def("execute", &NoiseSimulatorMPI::execute,
            "sampling & return result [array]");
    py::class_<GradCalculatorMPI>(m, "GradCalculatorMPI")
        .def(py::init<>(), "Constructor")
        .def("calculate_grad", &GradCalculatorMPI::calculate_grad,
            "sampling & return result [array]");
#endif
}
