...
public:
    ...
    double get_parameter(const ParameterKey& parameter_id) const;
    void add_parameter_value(UINT index, double value);
    void add_parameter_value(const ParameterKey& parameter_id, double value);
    void set_parameter_value(UINT index, double value);
    void set_parameter_value(const ParameterKey& parameter_id, double value);
