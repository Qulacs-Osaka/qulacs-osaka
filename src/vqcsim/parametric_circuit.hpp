...
public:
    ...
    virtual void pop_gate() override;
    ...
    virtual void add_parametric_RX_gate(UINT target_index, UINT share_with,
        double (*angle_func)(double) = identity_map);
    virtual void add_parametric_RY_gate(UINT target_index,
        double initial_parameter, double (*angle_func)(double) = identity_map);
    virtual void add_parametric_RY_gate(UINT target_index, UINT share_with,
        double (*angle_func)(double) = identity_map);
    virtual void add_parametric_RZ_gate(UINT target_index,
        double initial_parameter, double (*angle_func)(double) = identity_map);
    virtual void add_parametric_RZ_gate(UINT target_index, UINT share_with,
        double (*angle_func)(double) = identity_map);
